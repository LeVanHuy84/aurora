...
- [ ] **Task 2.5:** **Friends Module:** Gửi/Chấp nhận lời mời kết bạn, Hủy kết bạn, Đánh dấu `Close Friends`.
- [ ] **Task 2.6:** **Reactions & Private Comments Module:** Thả/Gỡ Reaction, Đăng & Xem Comment riêng tư 1-1.
...
## 🚀 Phase 4: Integration, Push Notification & Polishing
- [ ] **Task 4.1:** **Push Notifications:** Tích hợp `expo-notifications` và Firebase FCM.
- [ ] **Task 4.2:** **Tối ưu hóa hiệu năng Mobile:** Áp dụng `expo-image` để nén và cache ảnh mượt mà.
- [ ] **Task 4.3:** **Kiểm thử toàn diện:** Test luồng sử dụng thực tế giữa 2 máy iPhone qua Expo Go.
- [ ] **Task 4.4:** **Deployment Readiness:** Cấu hình Docker cho NestJS Backend & PostgreSQL Database.
