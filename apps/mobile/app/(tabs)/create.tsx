  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Title level={1}>{t('tabs.create')}</Title>
        <Body color="secondary">{t('moments.whatsHappening')}</Body>
      </View>
      ...
      <Card style={styles.card}>
        ...
        <Body color="secondary" align="center">
          Interactive Bottom Sheet with Photo, Note & Mood creation flow will be available in Task 3.4.
        </Body>
      </Card>
    </ScreenContainer>
  );
